...
public class AG1_MNUMP {
     ...
     */
    public AG1_MNUMP(int epoch, int populationSize, int dnaSize, double offspring, double elite, double mutation, int tournament_size, double min, double max) {
        this.genMax = epoch;
    ...
    public void run() {
        ...
        for (int genAct = 0; genAct < genMax; genAct++) {
            ...
            MultiNonUniformMutationPercent.mutacion(listNoCruzada, numMutacion, min, max, genAct, genMax);
