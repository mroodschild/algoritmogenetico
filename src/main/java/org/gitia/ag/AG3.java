...
public class AG3 {
    ...
    public AG3(int epoch, int populationSize, int dnaSize, double elite, double mutation) {
        this.epoch = epoch;
    ...
    public AG3(int epoch, int populationSize, int dnaSize, double elite, double mutation, double min, double max) {
        this.epoch = epoch;
        this.populationSize = populationSize;
        this.dnaSize = dnaSize;
        this.elite = elite;
